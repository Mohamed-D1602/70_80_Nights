// Admin backend for the Node server: talks to /api/admin with a password
// login. The login token is kept in localStorage so a page reload during
// event prep doesn't log you out (tokens expire after 12 hours).
...
export const duplicateEvent = (id) => request('POST', `/events/${id}/duplicate`);
